...
exports.cerrarSesion = (req,res)=>{
    req.session.destroy(()=>{
        res.redirect('/iniciar-sesion'); //al cerrar sesion nos lleva a inicar sesion
    })
}
...
exports.enviarToken = async (req, res) => {
    ...
    // para que luego de solicitar un cambio de contraseña, redirigir
...
exports.actualizarPassword = async (req, res) => {
    ...
    //limpio los campos de token y expiracion
    usuario.token = null; 
